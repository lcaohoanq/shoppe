package com.lcaohoanq.jvservice.constant;
...
public class MessageKey {
        ...
        public static final String OTP_IS_CORRECT = "user.verify.otp_is_correct";
        public static final String OTP_IS_INCORRECT = "user.verify.otp_is_incorrect";
