package com.lcaohoanq.jvservice.domain.payment;
...
import com.lcaohoanq.jvservice.domain.order.IOrderService;
import com.lcaohoanq.jvservice.domain.order.Order;
import com.lcaohoanq.jvservice.domain.order.Order.OrderStatus;
import com.lcaohoanq.jvservice.domain.payment.Payment.EPaymentStatus;
import com.lcaohoanq.jvservice.domain.payment.Payment.EPaymentType;
...
public class PaymentService implements IPaymentService {
    ...
    private final com.lcaohoanq.jvservice.config.VNPayConfig VNPayConfig;
    ...
    private Map<String, String> createVNPayPayment(PaymentDTO paymentDTO, String ipAddress, String orderInfoPrefix)
        ...
        String vnp_TxnRef = com.lcaohoanq.jvservice.config.VNPayConfig.getRandomNumber(8);
    ...
    private String createPaymentUrl(Map<String, String> vnp_Params) throws UnsupportedEncodingException {
        ...
        String vnp_SecureHash = com.lcaohoanq.jvservice.config.VNPayConfig.hmacSHA512(VNPayConfig.getVnp_HashSecret(), hashData.toString());
