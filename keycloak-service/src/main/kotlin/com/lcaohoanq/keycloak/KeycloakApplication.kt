package com.lcaohoanq.keycloak
...
@EnableJpaRepositories(basePackages = ["com.lcaohoanq.keycloak"])
class MoviesApiApplication

fun main(args: Array<String>) {
    val context = runApplication<MoviesApiApplication>(*args)
    val env = context.environment
    val activeProfiles = env.activeProfiles

    if (!activeProfiles.contains("docker")) {
        openHomePage("http://localhost:9080/swagger-ui/index.html")
    }
}
