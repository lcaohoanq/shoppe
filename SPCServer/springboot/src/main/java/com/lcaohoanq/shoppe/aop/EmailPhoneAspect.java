package com.lcaohoanq.shoppe.aop;

import com.lcaohoanq.shoppe.enums.UserStatus;
import com.lcaohoanq.shoppe.exception.UserHasBeenBannedException;
import com.lcaohoanq.shoppe.exception.UserHasBeenVerifiedException;
...
public class EmailPhoneAspect {
    ...
    @Before("execution(* com.lcaohoanq.shoppe.domain.mail.MailController.*(..)) && args(toEmail,..) && !@annotation(com.lcaohoanq.shoppe.annotation.SkipEmailValidation)")
