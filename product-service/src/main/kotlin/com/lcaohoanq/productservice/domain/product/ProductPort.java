...
import com.lcaohoanq.common.metadata.MediaMeta;
import com.lcaohoanq.productservice.domain.category.CatePort.CategoryResponse;
...
public interface ProductPort {
    ...
    record ProductResponse(
        ...
        @JsonIgnore
        @JsonProperty("status") ProductEnum.Status status,
